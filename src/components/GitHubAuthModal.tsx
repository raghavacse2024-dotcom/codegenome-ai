    ...
    <div className="auth-modal-overlay" onClick={onClose}>
      ...
      >
        ...
        <div className="auth-tab-content" style={{ padding: '24px 0' }}>
          <div className="auth-oauth-box" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: '12px' }}>
            <button 
              type="button"
            ...
            >
              <GitBranch className="w-5 h-5 mr-2 text-[#22c55e]" />
              <span>
                {loading ? 'Opening GitHub OAuth...' : 'Sign in with GitHub'}
              </span>
            </button>
